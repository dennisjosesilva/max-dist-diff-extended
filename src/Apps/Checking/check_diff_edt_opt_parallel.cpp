...
int main(int argc, char *argv[])
{
  ...
  using MTree = MaxDistComputerOptParallel::MTree;
  using NodePtr = MaxDistComputerOptParallel::NodePtr;
  ...
  std::vector<uint32> maxDistOpt = computeMaxDistanceAttributeOptParallel(domain, f, tree);
