...
// Useful function
std::vector<morphotree::uint32> computeMaxDistanceAttributeOptParallel(
  const morphotree::Box &domain,
  const std::vector<morphotree::uint8> &f,
  const MaxDistComputerOptParallel::MTree &tree)
{
  MaxDistComputerOptParallel comp{domain, f};
  return comp.computeAttribute(tree);
}

MaxDistComputerOptParallel::MaxDistComputerOptParallel(const Box& domain,
  const std::vector<uint8> &f)
  : domain_{domain}, f_{f}, 
    OFFSET_NEIGHBOR{ {-1, 0}, {0, -1}, {1, 0}, {0, 1}}
{ }

std::vector<MaxDistComputerOptParallel::uint32> 
  MaxDistComputerOptParallel::computeAttribute(const MTree &tree) const 
{
...
std::array<std::vector<MaxDistComputerOptParallel::NodePtr>, 256>
  MaxDistComputerOptParallel::extractLevelMap(const MTree &tree) const 
{
...
gft::sImage32 *MaxDistComputerOptParallel::createGFTImage() const 
{
...
void MaxDistComputerOptParallel::initPredAndRoot(gft::sImage32 *pred, gft::sImage32 *root) const 
{
...
void MaxDistComputerOptParallel::insertNeighborsPQueue(
  uint32 pidx,
  gft::sImage32 *bin,
  gft::sImage32 *cost,
