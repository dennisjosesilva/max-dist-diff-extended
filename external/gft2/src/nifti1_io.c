...
#include "gft2/nifti1_io.h"   /* typedefs, prototypes, macros, etc. */
...
{
   switch( dt ){
     case NIFTI_DT_UNKNOWN:    return "UNKNOWN"    ;
     case NIFTI_DT_BINARY:     return "BINARY"     ;
     case NIFTI_DT_INT8:       return "INT8"       ;
     case NIFTI_DT_UINT8:      return "UINT8"      ;
     case NIFTI_DT_INT16:      return "INT16"      ;
     case NIFTI_DT_UINT16:     return "UINT16"     ;
     case NIFTI_DT_INT32:      return "INT32"      ;
     case NIFTI_DT_UINT32:     return "UINT32"     ;
     case NIFTI_DT_INT64:      return "INT64"      ;
     case NIFTI_DT_UINT64:     return "UINT64"     ;
     case NIFTI_DT_FLOAT32:    return "FLOAT32"    ;
     case NIFTI_DT_FLOAT64:    return "FLOAT64"    ;
     case NIFTI_DT_FLOAT128:   return "FLOAT128"   ;
     case NIFTI_DT_COMPLEX64:  return "COMPLEX64"  ;
     case NIFTI_DT_COMPLEX128: return "COMPLEX128" ;
     case NIFTI_DT_COMPLEX256: return "COMPLEX256" ;
     case NIFTI_DT_RGB24:      return "RGB24"      ;
     case NIFTI_DT_RGBA32:     return "RGBA32"     ;
   }
   return "**ILLEGAL**" ;
}
...
{
   switch( dt ){
     case NIFTI_DT_UNKNOWN:    return 0 ;
     case NIFTI_DT_BINARY:     return 0 ;
     case NIFTI_DT_INT8:       return 1 ;
     case NIFTI_DT_UINT8:      return 1 ;
     case NIFTI_DT_INT16:      return 1 ;
     case NIFTI_DT_UINT16:     return 1 ;
     case NIFTI_DT_INT32:      return 1 ;
     case NIFTI_DT_UINT32:     return 1 ;
     case NIFTI_DT_INT64:      return 1 ;
     case NIFTI_DT_UINT64:     return 1 ;
     case NIFTI_DT_FLOAT32:    return 0 ;
     case NIFTI_DT_FLOAT64:    return 0 ;
     case NIFTI_DT_FLOAT128:   return 0 ;
     case NIFTI_DT_COMPLEX64:  return 0 ;
     case NIFTI_DT_COMPLEX128: return 0 ;
     case NIFTI_DT_COMPLEX256: return 0 ;
     case NIFTI_DT_RGB24:      return 1 ;
     case NIFTI_DT_RGBA32:     return 1 ;
   }
   return 0 ;
}
...
void nifti_datatype_sizes( int datatype , int *nbyper, int *swapsize )
{
   ...
   switch( datatype ){
     case NIFTI_DT_INT8:
     case NIFTI_DT_UINT8:       nb =  1 ; ss =  0 ; break ;

     case NIFTI_DT_INT16:
     case NIFTI_DT_UINT16:      nb =  2 ; ss =  2 ; break ;

     case NIFTI_DT_RGB24:       nb =  3 ; ss =  0 ; break ;
     case NIFTI_DT_RGBA32:      nb =  4 ; ss =  0 ; break ;

     case NIFTI_DT_INT32:
     case NIFTI_DT_UINT32:
     case NIFTI_DT_FLOAT32:     nb =  4 ; ss =  4 ; break ;

     case NIFTI_DT_COMPLEX64:   nb =  8 ; ss =  4 ; break ;

     case NIFTI_DT_FLOAT64:
     case NIFTI_DT_INT64:
     case NIFTI_DT_UINT64:      nb =  8 ; ss =  8 ; break ;

     case NIFTI_DT_FLOAT128:    nb = 16 ; ss = 16 ; break ;

     case NIFTI_DT_COMPLEX128:  nb = 16 ; ss =  8 ; break ;

     case NIFTI_DT_COMPLEX256:  nb = 32 ; ss = 16 ; break ;
   }
                                    ...
                                    const char * fname)
{
   ...
   if( nhdr.datatype == NIFTI_DT_BINARY ||
       nhdr.datatype == NIFTI_DT_UNKNOWN  )    ERREX("bad datatype") ;
...
nifti_image* nifti_simple_init_nim(void)
{
  ...
  int nbyper, swapsize;
   ...
   nhdr.datatype = NIFTI_DT_FLOAT32 ;
...
int nifti_datatype_from_string( const char * name )
{
    ...
    if( !name ) return NIFTI_DT_UNKNOWN;
...
int nifti_datatype_is_valid( int dtype, int for_nifti )
{
    ...
    /* special case */
    if( for_nifti && dtype == NIFTI_DT_BINARY ) return 0;
