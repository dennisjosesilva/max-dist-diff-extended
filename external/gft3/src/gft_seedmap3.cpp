...
namespace gft{
  namespace AdjSeedmap3{
	...
	gft::Error((char *)MSG1,
      ...
      asmap->object = ((sAdjRegion3 **)
		       calloc(nobjs+1, sizeof(sAdjRegion3 *)));
      asmap->obj_border = ((sAdjRegion3 **)
			   calloc(nobjs+1,
				  sizeof(sAdjRegion3 *)));
      asmap->bkg_border = ((sAdjRegion3 **)
			   calloc(nobjs+1,
				  sizeof(sAdjRegion3 *)));
      asmap->uncertainty = ((sAdjRegion3 **)
			    calloc(nobjs+1,
				   sizeof(sAdjRegion3 *)));
	...
	*asmap = NULL;
	...
	bmask = Scene8::GetObjBorders(mask, A);
	...
	fbmask = Scene8::GetObjBorders(fmask, A);
