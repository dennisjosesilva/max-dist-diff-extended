...
def main(RESOLUTION="1920x1080"):
  ...
  diff_max_dist_opt3_runtime = extract_mean_runtime(join("diff_max_dist_opt3", f"{RESOLUTION}"))
  ...
  df = df.assign(
    **{ "runtime_non_diff": non_diff_runtime ,
      ...
      "runtime_max_dist_opt3": diff_max_dist_opt3_runtime,      
      "speedup_non_diff": non_diff_runtime / diff_max_dist_opt3_runtime, 
      "speedup_exact": exact_edt_runtime / diff_max_dist_opt3_runtime,
      "speedup_max_diff": diff_max_runtime / diff_max_dist_opt3_runtime,
      "speedup_max_dist_opt2": diff_max_dist_opt2_runtime / diff_max_dist_opt3_runtime,
      })
